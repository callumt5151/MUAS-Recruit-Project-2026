...
Designed a simple PCB board that uses an analog MEMS microphone connected via a passive bridge-T zöbel 4kHz high-boost filter to an STM32L432KC microcontroller. 
